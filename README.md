...
站点代码位于 `docs/`，结果池为 20 位英雄，基础题库 38 题，开局随机抽取 12 题，部分答案会触发追问，单次测试总题数会落在 12 到 20 题之间。
...
- 结果池现在使用 20 位英雄。由于 `38 题 x 4 选项 = 152`，无法被 20 整除，所以基础池采用近似均衡映射：部分英雄出现 8 次，部分英雄出现 7 次，整体尽量拉平。
