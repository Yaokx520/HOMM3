window.QUIZ_DATA = (() => {
  ...
  const questions = [
    ...
    },
    {
      ...
      options: [
        { label: "导航型队长", detail: "你画路线比别人画饼还快。", axes: { rush: 2, econ: 1 } },
        { label: "保姆型指挥", detail: "谁漏兵谁断链，你全看在眼里。", axes: { control: 2, honor: 1 } },
        { label: "节目效果担当", detail: "能赢最好，不能赢也得炸得响。", axes: { chaos: 2, weird: 1 } },
        { label: "幕后军师", detail: "嘴上话不多，心里已经演了三轮。", axes: { control: 1, weird: 2 } },
      ],
    },
    {
      category: "打架气质",
      ...
      options: [
        { label: "绕", detail: "先估算距离和后续接力，别白给。", axes: { rush: 1, econ: 1, control: 1 } },
        { label: "点", detail: "先给他来一波大的，火爹精神永不熄灭。", axes: { rush: 2, chaos: 1 } },
        { label: "拖", detail: "让他急，你不急，回合数也是武器。", axes: { control: 2, honor: 1 } },
        { label: "算", detail: "我得知道他法力、兵力、地形和心态。", axes: { control: 1, weird: 1, econ: 1 } },
      ],
    },
    {
      category: "资源态度",
    ...
    },
    {
      ...
      options: [
        { label: "侦察与开图", detail: "先把地图撕开，后面都好说。", axes: { rush: 2, control: 1 } },
        { label: "财政与补给", detail: "兵马未动，账本先行。", axes: { econ: 3 } },
        { label: "爆破与斩首", detail: "会开会有什么用，关键时刻得有人上。", axes: { chaos: 2, rush: 1 } },
        { label: "防线与兜底", detail: "大家上头的时候，总得有人把锅盖盖住。", axes: { honor: 2, control: 1 } },
      ],
    },
    {
      category: "阵营偏好",
    ...
    },
    {
      ...
      options: [
        { label: "梭哈", detail: "这种局面不冲，何时冲。", axes: { rush: 2, chaos: 1 } },
        { label: "半冲半留", detail: "我可以冒险，但得给自己留后手。", axes: { control: 2, honor: 1 } },
        { label: "除非血赚", detail: "没有充分收益，不值得。", axes: { econ: 2, control: 1 } },
        { label: "看观众多不多", detail: "要是够戏剧性，我愿意。", axes: { weird: 2, chaos: 1 } },
      ],
    },
    {
      category: "社交观感",
    ...
    },
    {
      ...
      title: "你最羡慕哪种名场面？",
      options: [
        { label: "全图飞奔抢节奏", detail: "每一步都像提前写好的。", axes: { rush: 3 } },
        { label: "坐城数钱看别人急", detail: "富才是最大的自由。", axes: { econ: 3 } },
        { label: "一发把人点静音", detail: "高光就是要响。", axes: { chaos: 2, weird: 1 } },
        { label: "硬扛一切然后反杀", detail: "别人越急，我越稳。", axes: { honor: 2, control: 1 } },
      ],
    },
    {
      category: "心态调色盘",
      title: "你觉得自己更接近哪种底色？",
      options: [
        { label: "风", detail: "自由、迅速、很难被抓住。", axes: { rush: 3 } },
        { label: "金", detail: "现实、冷静、看重价值。", axes: { econ: 3 } },
        { label: "火", detail: "热烈、直接、容易点燃全场。", axes: { chaos: 2, honor: 1 } },
        { label: "潮", detail: "灵巧、克制、会等时机。", axes: { control: 2, weird: 1 } },
      ],
    },
    {
      category: "终局判断",
